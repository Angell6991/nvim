...
\usepackage{amssymb}
\usepackage{graphicx}
\usepackage{newtxtext}  % Paquete para cambiar la fuente del texto
\usepackage{newtxmath}  % Paquete para cambiar la fuente de las ecuaciones
% \usepackage{rsfso}      % Paquete para fuentes matemáticas caligráficas
\usepackage{color}
\usepackage{parskip}
...
% Imagen_sin_alinear_libre:
% \usepackage[absolute,overlay]{textpos}

% \begin{textblock*}{10cm}(-12cm,-5cm)  % (ancho del bloque, posición x, y)
%     \includegraphics[width=45cm]{photo_2025-06-03_11-43-54.jpg}
% \end{textblock*}
